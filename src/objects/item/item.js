...
export class Item extends Object {
    ...
    respawn(player) {
        ...
        if (this.timetokill <= 0) {
            ...
            camera.updateMatrixWorld();
            if (this.reset < 0) {
                this.x = player.x+ this.getRandomInt(30,70) * (this.getRandomInt(-2, 2) > 0 ? 1 : -1);
                this.y = player.y//+ this.getRandomInt(30, 70) * (this.getRandomInt(-2, 2) > 0 ? 1 : -1);
                this.z = player.z + this.getRandomInt(30, 70) * (this.getRandomInt(-2, 2) > 0 ? 1 : -1);
